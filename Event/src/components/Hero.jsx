...
const slides =[
...

    {
      ...
      description: "Experience insightful talks, strategic panels, and practical sessions designed to spark growth, leadership, and transformation."
    },

    {
      image: slide3,
      title:"Africa’s Next Moves Start Here",
      description: "Catalyst X Conference is the meeting point for those ready to create solutions, scale ideas, and influence the future."
    }
]
